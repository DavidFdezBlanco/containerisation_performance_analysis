...
repetitions=$1
script=$2
output_file="/tmp/perf_study/test/k3s_crio/results/untreated_k3s_crio_build_update_run_time.txt"
...
for i in $(seq 1 $repetitions); do
  ...
  kubectl cp /tmp/perf_study/test/k3s_crio/$script.c test-$script-$i:/tmp
